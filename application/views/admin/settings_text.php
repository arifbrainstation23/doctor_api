										...
										<div class="panel panel-default">
											...
											<div id="accordion_<?php echo $i;?>" class="panel-collapse collapse <?php echo $colpsIn; ?>" role="tabpanel" aria-labelledby="heading_<?php echo $i;?>">
												<div class="panel-body">
													...
													<div class="hs_datatable_wrapper hs_datatable_language">
														<table class="commonTable hs_datatable table table-bordered" cellspacing="0" width="100%">
														<?php
...
<!-- Common modal start -->
<!-- Modal -->
<div class="modal fade " id="commonLanguageModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <div class="hs_input">
		    <label>Change Language Text</label>
             <input type="text" class="form-control" id="langText">
		  </div>
		  <div class="hs_input">
			  <button type="button" class="btn  languageUpdateBtn">Update</button>
          </div>
      </div>
    </div>
  </div>
